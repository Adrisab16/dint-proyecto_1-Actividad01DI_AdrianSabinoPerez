package com.example.actividad1di.habilidadesdelcampeon
...
/**
 * This composable was generated from the UI Package 'habilidades_del_campeon'.
 * Generated code; do not edit directly
 */
@Composable
fun HabilidadesDelCampeon(modifier: Modifier = Modifier) {
...
@Composable
private fun HabilidadesDelCampeonPreview() {
    MaterialTheme {
        HabilidadesDelCampeon()
    }
}
...
fun HABILIDADES(modifier: Modifier = Modifier) {
    RelayText(
        ...
        maxLines = -1,
        modifier = modifier.requiredWidth(160.30868530273438.dp).requiredHeight(29.696969985961914.dp).wrapContentHeight(align = Alignment.CenterVertically)
    )
}
...
fun Image7(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.habilidades_del_campeon_image_7),
...
fun Image8(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.habilidades_del_campeon_image_8),
        contentScale = ContentScale.Crop,
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Image10(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.habilidades_del_campeon_image_10),
        contentScale = ContentScale.Crop,
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Image9(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.habilidades_del_campeon_image_9),
        contentScale = ContentScale.Crop,
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Image33(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.habilidades_del_campeon_image_33),
        contentScale = ContentScale.Crop,
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 7.3828125.dp,
...
fun Group1(
    ...
    RelayContainer(
        ...
        clipToParent = false,
        content = content,
        modifier = modifier.requiredWidth(328.00006103515625.dp).requiredHeight(67.8787841796875.dp)
    )
}
